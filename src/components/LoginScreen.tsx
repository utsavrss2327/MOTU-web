    ...
    <div className="flex h-[100dvh] w-screen items-center justify-center bg-[#E6D7B9] font-sans text-zinc-900">
      <div className="w-full max-w-md p-8 bg-white/30 backdrop-blur-2xl rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] border border-white/50 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm font-medium text-zinc-600 mb-2 tracking-wide">
            <span className="text-orange-600 font-extrabold text-base">M</span>ap <span className="text-orange-600 font-extrabold text-base">O</span>f <span className="text-orange-600 font-extrabold text-base">T</span>houghts & <span className="text-orange-600 font-extrabold text-base">U</span>nified-notes
          </p>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl font-medium transition-all shadow-lg active:scale-[0.98] disabled:opacity-70"
          >
            {isLoading ? (
